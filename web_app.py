...
def main():
    ...
    parser.add_argument("--host", default=os.environ.get("WEB_HOST", "0.0.0.0"), help="Хост")
    parser.add_argument("--port", type=int, default=int(os.environ.get("WEB_PORT", 8080)), help="Порт")
